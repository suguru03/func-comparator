 ...
 * @param {Boolean} options.result - display result array [ns] | default false
 * @param {Boolean} options.average - calculate average [ns] | default true
 * @param {Boolean} options.variance - calcuate variance | default true
 * @param {Boolean} options.standard_deviation - calcuate standard deviation [ns] | default true
...
function getTimer() {
  ...
  return process ? nodeTimer() : jsTimer();
}
